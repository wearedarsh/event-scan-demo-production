<div class="space-y-6">
    ...
    <x-admin.breadcrumb :items="[
        ...
        ['label' => 'Edit Session Group'],
    ]" />

    <!-- Header -->
    <div class="px-6">
        <h1 class="text-2xl font-semibold text-[var(--color-text)]">Edit Session Group</h1>
        <p class="text-sm text-[var(--color-text-light)] mt-1">
            Update the details of this session group.
        </p>
    </div>
            ...
            <form wire:submit.prevent="update" class="space-y-6">
                ...
                <div class="flex items-center gap-3 pt-2">
                    ...
                    <button type="submit"
                        ...
                        <span class="hidden md:inline">Update group</span>
                    </button>

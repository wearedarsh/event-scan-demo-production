<div>
    <div class="flex-row d-flex flex-1 rounded-2 p-3 align-items-center">
        <h2 class="fs-4 text-brand-dark p-0 m-0">Create Event Content</h2>
    </div>
    ...
    <div class="flex-row d-flex flex-1 bg-white rounded-2 p-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb d-flex flex-row align-items-center">
                ...
                <li class="breadcrumb-item active" aria-current="page">Create Event Content</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="flex-column d-flex p-3 bg-white rounded-2 mt-3">
        <div class="container mt-2">
            <h4 class="mb-3">Create Content Section</h4>
            ...
            <form wire:submit.prevent="store" class="row g-3">
                ...
                <div class="col-12">
                    <button type="submit" class="btn bg-brand-secondary">Create Content Section</button>

<div>
    <div class="flex-row d-flex flex-1 rounded-2 p-3 align-items-center">
        <h2 class="fs-4 text-brand-dark p-0 m-0">Edit Ticket</h2>
    </div>
    ...
    <div class="flex-column d-flex p-3 bg-white rounded-2 mt-3">
        <div class="container mt-2">
            ...
            <form wire:submit.prevent="update" class="row g-3">
                ...
                @if($ticket->ticketGroup->multiple_select)
                <div class="col-md-6">
                    <label for="max_volume" class="form-label">Max Volume</label>
                ...
                <div class="col-md-6">
                    ...
                    <textarea wire:model.live="requires_document_copy" type="text" class="form-control" id="requires_document_copy" rows="4"></textarea>
                </div>
                ...
                <div class="col-12">
                    <button type="submit" class="btn bg-brand-secondary">Update Ticket</button>

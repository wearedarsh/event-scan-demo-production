...
<style>
  ...
  .overlay__name { font-family: 'NotoSans', sans-serif; font-weight: 700; font-size: 19pt; margin-top:28mm;}
  .overlay__name .line { display: block; line-height: 0.88; }

  .overlay__country { font-size: 14pt; margin-top: .5mm; }

  .overlay__qrwrap { margin: 4mm auto 0; width: 35mm; height: 35mm; }
    ...
    <div class="label">
      ...
      @else
        <div class="overlay" style="background: #fff;">
          ...
          <div class="overlay__country">{{ $vm->country }}</div>

          <div class="overlay__qrwrap">
              <img src="data:image/svg+xml;base64,{{ base64_encode(QrCode::format('svg')->size(600)->generate($vm->qr_data)) }}" alt="QR" />
          </div>

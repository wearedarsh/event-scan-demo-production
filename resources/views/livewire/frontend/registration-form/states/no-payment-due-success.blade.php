<div class="space-y-4">
    <x-registration.form-step>
        ...
        {!! client_setting('payment.booking.no_payment_due.checkout.success.header_html') !!}
        ...
        <div class="bg-[var(--color-accent-light)] border-l-4 border-[var(--color-accent)] p-5 rounded-lg text-sm text-[var(--color-secondary)] space-y-2">
            ...
            {!! client_setting('payment.booking.no_payment_due.checkout.success.details_html') !!}
        ...
        <x-registration.navigate-button
            ...
            {{ client_setting('payment.booking.no_payment_due.checkout.success.finish_button_label') }}
        </x-registration.navigate-button>

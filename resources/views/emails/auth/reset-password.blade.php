...
@section('content')
    <p>You recently requested to reset your password for your Medical Foundry account. Click the button below to reset it:</p>
    ...
    <p>Thanks,<br>The Medical Foundry Team</p>
@endsection
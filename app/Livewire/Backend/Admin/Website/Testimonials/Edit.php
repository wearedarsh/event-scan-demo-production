...
class Edit extends Component
{
    ...
    public function mount(Testimonial $testimonial)
    {
        ...
        $this->sub_title = $testimonial->sub_title;
        $this->content = $testimonial->content;
        $this->star_rating = $testimonial->star_rating;
        $this->active = (string) $testimonial->active;
    ...
    {
        return view('livewire.backend.admin.website.testimonials.edit');
    }
}
